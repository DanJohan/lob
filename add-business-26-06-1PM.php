...
$business_address2 = mysqli_real_escape_string($link, md5($_POST['business_address2']));
...
/*echo "INSERT INTO `tbl_businessinfo` (`business_id`, `username`, `email`, `business_name`, `business_address1`, `business_address2`, `business_city`, `business_state`, `business_zip`,`business_email`,`business_phone`,`business_website`,`business_category`,`business_subcategory`) 
	VALUES ('', '$username', '$email', '$business_name', '$business_address1', '$business_address2', '$business_city', '$business_state', '$business_zip', '$business_email', '$business_phone','$business_website','$category',$scategory)";die;
*/
	...
	VALUES ('', '$username', '$email', '$business_name', '$business_address1', '$business_address2', '$business_city', '$business_state', '$business_zip', '$business_email', '$business_phone','$business_website','$category',$scategory";
	...
	<section id="page-title">
		...
		<section id="add-bussines">
			...
			<div class="container clearfix">
				...
				<form id="addb" name="add-bussines" id="add-bussines" method="post" action="">
				<div id="message"></div>
				...
				<input type ="button" value="submit"  name="businessSubmit" id="businessSubmit"  class="btn btn-primary"  />
					</div>
				</form>
			</div>
