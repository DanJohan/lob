...
if(isset($_POST['upDProfile']))
  ...
  //echo "UPDATE  `tbl_users` SET  `user_name` =  '".$user_name."',`user_email` =  '".$user_email."', `user_first_name` =  '".$user_first_name."', `user_last_name` =  '".$user_last_name."', `password` =  '".$password."' WHERE  `tbl_users`.`user_id` ='".$id."'";
