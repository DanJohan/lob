...
if($video_id)
 {
	...
	echo "UPDATE into  tbl_videos  SET video_title='".$video_title."', video_desc='".$video_desc."',video_url='".$video_url."' where video_id='$video_id'"; die;
