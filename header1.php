...
<body class="stretched">
	...
	<!-- Document Wrapper
	============================================= -->
	<div id="wrapper" class="clearfix header1">

		<!-- Header
		============================================= -->
		<header id="header" class="full-header header1">
			...
			<div class="container">
				...
				<form method="post" action="add-business.php" class="searchform">					
						...
						<!--<button class="button search-button btn">Go</button>-->
						 <input type = "submit" value="Go"  name="search" id="search"  class="button search-button btn" />
